# My first CS Project
A 2D Flappy bird remake built using Python, CSS, PyGame,in which the player can control the movement of the flappy bird using up arrow to avoid incoming obstacle.
